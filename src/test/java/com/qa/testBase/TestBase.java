...
public class TestBase {
   ...
   public WebDriver addToCartBeforeCheckout() {
		HomePage homepage= new HomePage(driver);
		homepage.enterProductDetail(dataProp.getProperty("validProduct"));
		
		SearchProductPage searchproductpage= homepage.clickOnSearchIcon();
		
		Assert.assertTrue(searchproductpage.verifyDisplayStatusOfValidProduct());
		searchproductpage.clickOnAddtoCart(); //redirected tonew page 
